            ...
            _0xb07ax3(document)['ready'](function () {
                if ('undefined' == typeof pdfflipLocation && 0 != pdfflip['autoDetectLocation'] && _0xb07ax3('script')['each'](function () {
                    ...
                    'undefined' != typeof pdfflipLocation && (pdfflipLocation['length'] > 2 && '/' !== pdfflipLocation['slice'](-1) && (window['pdfflipLocation'] += '/'),
                        pdfflip['defaults']['pdfjsSrc'] = pdfflipLocation + 'js/pdf.min.js',
                        pdfflip['defaults']['threejsSrc'] = pdfflipLocation + 'js/three.min.js',
                        pdfflip['defaults']['pdfjsWorkerSrc'] = pdfflipLocation + 'js/pdf.worker.min.js',
                        ...
                        pdfflip['defaults']['cMapUrl'] = 'https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.11.338/cmaps/',
